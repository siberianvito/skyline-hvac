...
const SECTIONS: { h: string; p: string[] }[] = [
  ...
  },
  {
    ...
    p: [
      "If you provide your mobile number and opt in, we may send you text messages about your request — appointment scheduling and confirmations, technician arrival updates, estimates and follow-up, and service reminders. Consent to receive text messages is not a condition of purchasing any goods or services from us. Reply STOP to opt out at any time, or HELP for help. Message and data rates may apply and message frequency varies. Our full messaging terms are set out in our Terms of Service.",
